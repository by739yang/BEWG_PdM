...
df.to_csv(os.path.join(OUT,'protocol_v12_per_file.csv'),index=False,encoding='utf-8-sig')
dd.to_csv(os.path.join(OUT,'protocol_v12_det.csv'),index=False,encoding='utf-8-sig')
...
open(os.path.join(OUT,'protocol_v12_summary.md'),'w',encoding='utf-8').write(
