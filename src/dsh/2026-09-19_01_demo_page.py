...
h.append('<div class="kpi"><div class="v">+62%</div><div class="l">湿泥饼产量变化（13.0→21.2 m³/d）</div></div>')
...
h.append('<div class="kpi"><div class="v">0.99 天</div><div class="l">剩余寿命误差（1 天机理窗）</div></div>')
h.append('</div>')
